...
Let $i$ denote the number of lineages in the current generation.
In the immediately previous generation, there are $i$ distinct ancestral lineages if no coalescent event has occurred, or ${i-1}$ otherwise.
