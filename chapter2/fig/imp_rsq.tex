...
Each imputed panel (imputations from the \n{4} split panels, the intersection panel, and the union panel) was separately compared to meta-imputation on the same set of variants per bin (\ie on the intersected set of SNPs per comparison); shown for variants retained after \gls{qc}, in Scenarios~A and B.
