...
%
\subsubsection{Simulated data after integration of error}
%
...
Recall \Correct{that} there are multiple focal alleles that may sit on the same underlying shared haplotype, such that the resulting set of segments inferred from all selected target sites may contain in duplicate segments.
...
%
\subsubsection{1000 Genomes data, chromosome 20}
%

I applied the HMM-based method on data from the \glsentryfull{1kg} Phase~\rom{3}, chromosome~20.
