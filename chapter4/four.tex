...
On average, an overlap of \Percent{98.85546} and \Percent{98.5524} was measured relative to an inferred IBD segment in \ref{A4:fgt_h} and \ref{A4:fgt_p}, respectively, but \Percent{18.7064} and \Percent{19.00517} on average when measured relative to a true segment, respectively.
...
The example shown in \cpref{fig:full_ibd_error} highlights the difference in coverage for IBD segments inferred using \texttt{Refined\,IBD} on data before and after the integration of error.
...
As a result, \dec{2.089489}~million segments in \ref{A4:fgt_h} and \dec{1.841095}~million segments in \ref{A4:fgt_p} were matched to the set of true intervals after removing duplicate segments in the latter.
